...
const run = () => { 
    ...
    nightmare
        ...
        // .click('#credit > div > img')

        // .insert('#form-op > div > div > div:nth-child(2) > div.col-lg-6.col-md-6.col-sm-6.line.col-md-push-2.col-lg-push-1 > div:nth-child(3) > input', 'teste')
        ...
        // .select('#form-op > div > div > div:nth-child(2) > div.col-lg-6.col-md-6.col-sm-6.line.col-md-push-2.col-lg-push-1 > div.col-lg-12.col-md-12.col-sm-12.m-b-sm > select', 1)
        // .insert('#form-op > div > div > div:nth-child(2) > div.col-lg-6.col-md-6.col-sm-6.line.col-md-push-2.col-lg-push-1 > div.col-lg-12.col-md-12.col-xs-12.m-b-md > input', 'marcio.hsdl@gmail.com')
  

        // .type('#cep', 53370525)
        // .insert('#street', 'Rua José P. de Oliveira')
        // .insert('#number', 06)
        // .insert('#complement', 'Quadra D16')
        // .select('#gateway-contact_type', 'cellphone')
        // .insert('#gateway-contact-ddd', 81)
        // .type('#gateway-contact', '998334195')
        // .insert('#neighborhood', 'Ouro Preto')
        // .insert('#uf', 'PE')
        // .insert('#city', 'Olinda')
