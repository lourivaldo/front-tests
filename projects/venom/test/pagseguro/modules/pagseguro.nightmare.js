...
const run = () => { 
    ...
    nightmare
        ...
        .click('#root > div > div.be-wrapper.be-nosidebar-left > div > div > div > div.col-md-9.col-xs-12 > div > div.panel-body.row.m-t-xs.m-b-n-sm > div:nth-child(5) > div > div > img')
        
        .insert('#form-op > div > div > div:nth-child(1) > input', 'teste teste')
        .type('#form-op > div > div > div:nth-child(2) > input', EMAIL)
        .type('#form-op > div > div > div:nth-child(3) > input', 10473322480)
        .click('#root > div > div.be-wrapper.be-nosidebar-left > div > div > div > div.col-md-9.col-xs-12 > div > div:nth-child(3) > div > div > div > div > div > div > button')
